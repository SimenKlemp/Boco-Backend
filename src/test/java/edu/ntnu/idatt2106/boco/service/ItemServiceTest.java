...
public class ItemServiceTest {
    ...
    public void setUp() {
        ...
        Item item1 = new Item("Address", 200,"Description", "Category", "Title", null, user);
    ...
    @Test
    void createItemTest(){
        RegisterItemRequest item = new RegisterItemRequest("Address", 200,"Description", "Category", "Title", 1L,null);
    ...
    void updateSpecificItem(){
        UpdateItemRequest updateItemRequest = new UpdateItemRequest("Address", 200f, "Description", "Category", "Title", 1L, null);
