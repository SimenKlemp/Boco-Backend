...
public class RentalServiceTest
{
    ...
    public void getAllWhereOwnerWithRentals()
    {
        ...
        List<RentalResponse> responses = rentalService.getAllWhereOwner(user1.getUserId());
    ...
    public void getAllWhereOwnerEmpty()
    {
        ...
        List<RentalResponse> responses = rentalService.getAllWhereOwner(user.getUserId());
    ...
    {
        List<RentalResponse> responses = rentalService.getAllWhereOwner(0L);
        assertThat(responses).isNull();
    }
